...
const tag = '✭'   
const kadınrol = message.guild.roles.cache.find(r => r.id === '810497712285024269') 
const kadınrol2 = message.guild.roles.cache.find(r => r.id === '810497712285024268')
...
.setAuthor(message.author.tag, message.author.avatarURL({dynamic:true}))
.setDescription(`Hey Sen ! Belirtilen kullanıcı sizden üst/aynı pozisyonda işleme devam edilemiyor.`)
.setColor('#a22a2a')).then(x => x.delete({timeout: 5000}));
